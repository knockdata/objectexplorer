...
<template>
	<footer class="story-footer">
		<div class="story-footer-share">
			...
			<ShareLink :url="pageUrl" :title="frontmatter.title" :text="frontmatter.answer" label="Share link" />
		</div>
		...
		<p class="story-footer-more">
			<a :href="withBase('/story/')">All stories</a> · <a :href="withBase('/#download')">Download ObjectExplorer</a>
		</p>
	</footer>
</template>
